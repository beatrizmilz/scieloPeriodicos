...
- [ ] Criar um fluxo de trabalho com GitHub Actions para salvar a página de instruções aos autores de cada periódico.
...
- [ ] Analisar: Quais são plataformas os periódicos utilizam para submissão de manuscritos (além do ScholarOne)? Quantos periódicos utilizam cada plataforma?
